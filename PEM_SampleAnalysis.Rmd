...
ancDatSL.dat <- as.data.frame(getValues(ancDatSL)) %>% drop_na() %>% unite(LHC.var, as.character(X1:X4, sep = ","))
...
collectStats <- function(X,sampleFun,nums,testFun1 = sumKSTestTransect,testFun2 = fillTest_Transect,ancDat){
