...
templhs <- c_clhs(x = Xcost, size = 100, i_cost = 7, iter = 10000)
tic()
testing <- CppLHS(Xcost, costVec, continuous_strata, size, T, iter = 10000)
toc()

Xcost[,7][is.infinite(Xcost[,7])] <- 1000
tic()
test2 <- clhs(x = as.data.frame(Xcost),size = size,cost = 'layer', simple = F)
toc()
...
nums <- round(seq(5, 1000, length.out = 50))
