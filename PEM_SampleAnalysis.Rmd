...
```{r run simulations}
nums <- round(seq(5, 50, length.out = 10)) ##set sequence of transect number
nums <- rep(nums, each = 10) ##replicates of each number (should be at least 5)
