...
ancDatSL.temp$twi[ancDatSL.temp$twi < 4.71 | ancDatSL.temp$twi > 7.16] <- NA
ancDatSL.temp$valley_depth_2[ancDatSL.temp$valley_depth_2  > 60.44] <- NA
ancDatSL.temp$tca2[ancDatSL.temp$tca2  > 470598] <- NA
ancDatSL.temp$swi_area_mod[ancDatSL.temp$swi_area_mod > 9465973] <- NA
...
writeRaster(newlayer, "./Tests/SelectedCovariateBins.tif", format = "GTiff", overwrite  = TRUE)
```
