...
clhsregTime <- collectTime2(Xcost,transSingleNum * 5)
clhsregTime$SType <- "Single Transect"
clhsregTime <- collectTime2(Xcost,transPairedNum * 5)
clhsregTime$SType <- "Paired Transect"
################################################################
##single points clhs sampled
...
SinglePoint <- foreach(n = 1:(nSims*nRep), .combine = rbind, .packages = pkgs,
